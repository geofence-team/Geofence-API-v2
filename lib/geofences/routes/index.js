...
var {createGeofence, getAllGeofences, getUserAllGeofences , getGeofence , updateGeofence, deleteGeofence,getAllInactiveGeofences, updateAdminGeo, activateGeofence, deactivateGeofence, getAllGeofencesAdmin} = require('../../geofences/controller');
const auth = require("../../auth-services");
const middleware = require("../middleware")

router.get("/", auth.verifyUser , auth.isAdminOrManager, getUserAllGeofences);

router.get("/allgeosadmin", auth.verifyUser,  auth.isAdminOrManager, getAllGeofencesAdmin);
