...
////CREATE GEOFENCE/////
exports.createGeofence = async (title, description, userId, isActive, ttGeoId, coordinates) => {
  try {
    const query = `INSERT INTO geofences (title, description, userId, isActive, ttGeoId, coordinates) VALUES (:title, :description, :userId, :isActive, :ttGeoId, :coordinates);`;
