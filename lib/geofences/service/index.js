...
exports.getGeofence = async (ttGeoId) => {
  try {
    const data = await axios(`https://api.tomtom.com/geofencing/1/fences/${ttGeoId}?key=EjgfZVuh2GOmFpkjSL0ucHFDEi24jxuf`)
    if (data.data.id) {
...
exports.getAllGeofencesAdmin = async (id) => {
  try {
    const data = await models.Geofence.findAll({
