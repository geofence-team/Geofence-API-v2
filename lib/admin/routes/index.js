...
var { admninSignIn, adminSignOut, activate, deactivate, getUsers, signupRequests, activateGeofence, deactivateGeofence} = require('../../admin/controller');
...
router.patch('/activateGeofence/:id' , auth.verifyUser , auth.isAdmin, activateGeofence);
router.patch('/deactivateGeofence/:id' , auth.verifyUser , auth.isAdmin, deactivateGeofence);
